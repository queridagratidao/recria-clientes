...
## 1. Bugs técnicos (prioridade alta, afeta captação de lead)

| Página | Problema | Por que ajustar |
|---|---|---|
| Sessão Estratégica — Executivos | Formulário sem botão de enviar | Ninguém consegue submeter o formulário; todo lead que preferisse essa via se perde |
| Sessão Estratégica — Síndicos | Formulário sem botão de enviar | Mesmo problema acima |
| Sessão Estratégica — Fornecedores | Botão "Agendar minha Sessão Estratégica" aparece **acima** do formulário, não como botão de envio | Confunde o usuário: parece um CTA solto, não o botão de submissão do formulário. Deveria vir depois dos campos |
| Diagnóstico — Executivos, Fornecedores e Síndicos | Mesmo padrão: formulário sem botão de enviar visível | Mesmo motivo acima, bug se repete nas 3 páginas de Diagnóstico também |

**Recomendação:** revisar o componente de formulário usado em todas as páginas (parece ser o mesmo template), corrigindo de uma vez só em vez de página por página.
...
**Como está:**
- H1: "Veja sua administradora ou imobiliária pelos olhos de quem já liderou as maiores operações do Brasil"
...
**Como está:**
- H1: "Veja sua empresa pelos olhos de quem já esteve do outro lado da mesa nas maiores operações do Brasil"
...
**Como está:**
- H1: "Veja sua atuação como síndico profissional pelos olhos de quem já geriu +2.200 condomínios"
...
**Sugestão:** "Saiba mais sobre a Mentoria 8S para Fornecedores **de** Condomínios →"

---

## 4. O que já está funcionando bem no Diagnóstico (referência a manter)

- H1 direto ao ponto ("Descubra o que trava o crescimento... em duas sessões")
