...
def post_card(time, channel, tipo, formato, headline, subheadline, cta,
              ...
              label_legenda="LEGENDA:", acoes=None, trechos=None):
    ...
    if cards:
        ...
        if trechos:
            body_flow.append(P("**ROTEIRO (teleprompter):**", fontSize=9.3, spaceAfter=4, **indent))
            for i, t in enumerate(trechos, start=1):
                body_flow.append(_card_box("TRECHO %d" % i, [P(t, fontSize=9, leading=12.3)],
