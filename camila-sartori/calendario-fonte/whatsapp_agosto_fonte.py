...
add_week("SEMANA 1 · 03 a 09/08")

add_day("03/08 (SEG), Reflexão — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="EXCLUSIVO (reflexão)",
         formato="Mensagem de texto",
         headline=None, subheadline=None, cta=None,
         acoes=[
             dict(label="Mensagem de reflexão",
                  texto="Bom dia / Boa tarde / Boa noite! Uma pergunta para começar a semana: o que você está adiando só porque tem medo do que pode dar errado, ou até do que pode dar certo?"),
         ]),
])

add_day("05/08 (QUA), Repost — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="REPOST (Instagram 05/08, mesmo dia)",
...
add_day("07/08 (SEX), Repost — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="REPOST (Instagram 07/08, mesmo dia)",
         formato="Texto de chamada + Repost (2 ações, enviar nessa ordem)",
         headline=None, subheadline=None, cta=None,
         acoes=[
             dict(label="Texto de chamada (enviar antes do repost)",
...
add_week("SEMANA 2 · 10 a 16/08")

add_day("10/08 (SEG), Técnica — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="EXCLUSIVO (técnica)",
         formato="Mensagem de texto",
         headline=None, subheadline=None, cta=None,
         acoes=[
             dict(label="Mensagem com técnica prática",
                  texto="Bom dia / Boa tarde / Boa noite! Uma técnica simples de TCC para hoje: da próxima vez que sentir ciúme ou insegurança forte numa relação, tente escrever em uma frase qual é o medo real por trás disso, antes de reagir. Muitas vezes o medo é mais antigo do que a situação em si."),
         ]),
])

add_day("12/08 (QUA), Repost — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="REPOST (Instagram 12/08, mesmo dia)",
         formato="Texto de chamada + Repost (2 ações, enviar nessa ordem)",
         headline=None, subheadline=None, cta=None,
         acoes=[
             dict(label="Texto de chamada (enviar antes do repost)",
...
add_day("14/08 (SEX), Repost — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="REPOST (Instagram 14/08, mesmo dia)",
         formato="Texto de chamada + Repost (2 ações, enviar nessa ordem)",
         headline=None, subheadline=None, cta=None,
         acoes=[
             dict(label="Texto de chamada (enviar antes do repost)",
...
add_week("SEMANA 3 · 17 a 23/08")

add_day("17/08 (SEG), Reflexão — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="EXCLUSIVO (reflexão)",
         formato="Mensagem de texto",
         headline=None, subheadline=None, cta=None,
         acoes=[
             dict(label="Mensagem de reflexão",
                  texto="Bom dia / Boa tarde / Boa noite! Você já se encolheu essa semana para não incomodar ninguém, para não parecer demais? Como foi isso para você?"),
         ]),
])

add_day("19/08 (QUA), Repost — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="REPOST (Instagram 19/08, mesmo dia)",
         formato="Texto de chamada + Repost (2 ações, enviar nessa ordem)",
         headline=None, subheadline=None, cta=None,
         acoes=[
             dict(label="Texto de chamada (enviar antes do repost)",
...
add_day("21/08 (SEX), Repost — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="REPOST (Instagram 21/08, mesmo dia)",
         formato="Texto de chamada + Repost (2 ações, enviar nessa ordem)",
         headline=None, subheadline=None, cta=None,
         acoes=[
             dict(label="Texto de chamada (enviar antes do repost)",
...
add_week("SEMANA 4 · 24 a 30/08")

add_day("24/08 (SEG), Enquete — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="EXCLUSIVO (enquete)",
         formato="Enquete do WhatsApp",
         headline=None, subheadline=None, cta=None,
         acoes=[
             dict(label="Enquete",
                  texto='"Qual desses temas de agosto mais fez sentido para você até agora?"\nOpções: Procrastinação / Perfeccionismo / Ciúme / Autoestima / Medo de ser vista / Padrões de relacionamento.'),
         ]),
])

add_day("26/08 (QUA), Repost — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="REPOST (Instagram 26/08, mesmo dia)",
         formato="Texto de chamada + Repost (2 ações, enviar nessa ordem)",
         headline=None, subheadline=None, cta=None,
         acoes=[
             dict(label="Texto de chamada (enviar antes do repost)",
...
add_day("28/08 (SEX), Repost — texto pronto para copiar e colar no grupo", [
    dict(time="09h", channel="WHATSAPP", tipo="REPOST (Instagram 28/08, mesmo dia)",
         formato="Texto de chamada + Repost (2 ações, enviar nessa ordem)",
         headline=None, subheadline=None, cta=None,
         acoes=[
             dict(label="Texto de chamada (enviar antes do repost)",
