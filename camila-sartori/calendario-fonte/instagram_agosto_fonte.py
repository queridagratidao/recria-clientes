# -*- coding: utf-8 -*-
# AGOSTO 2026 - INSTAGRAM - Jornada AME-SE
# Cadência: 2 posts/semana (quarta e sexta), intercalando estático, carrossel, estático, reel.
# Máximo 2 carrosséis no mês. Cada post, após publicado no Instagram, é repostado no
# grupo do WhatsApp no mesmo dia (ver observação).

add_month("AGOSTO 2026 - Instagram")
